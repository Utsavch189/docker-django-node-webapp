...
Volumes are easier to back up or migrate than bind mounts.<br/>
You can manage volumes using Docker CLI commands or the Docker API.<br/>
Volumes work on both Linux and Windows containers.<br/>
Volumes can be more safely shared among multiple containers.<br/>
Volume drivers let you store volumes on remote hosts or cloud providers, to encrypt the contents of volumes, or to add other functionality.<br/>
New volumes can have their content pre-populated by a container.<br/>
